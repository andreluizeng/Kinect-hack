...
class GLCVCube
{
	public:
		...
		void 	CubeCreateTex			(int texture_w, int texture_h);
		...
		void 	CubeReset			(void);
		void 	CubeSetFaceTex			(int face, IplImage *texture_data);
		void    CubeSetFaceTexBuf 		(int face, char *texture_data, int w, int h);
		void  	CubeSetFaceColor 		(int face, CvScalar color);
